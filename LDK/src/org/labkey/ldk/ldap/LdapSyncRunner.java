...
public class LdapSyncRunner implements Job
{
    ...
    private void updateLdapTable() throws LdapException
    {
        ...
        try
        {
            ...
            TableInfo ti = LDKSchema.getTable(LDKSchema.TABLE_LDAP_SYNC_MAP);
    ...
    private void deactivatePrincipalsPreviouslySynced()
    {
        ...
        Set<Integer> previouslySynced = new HashSet<Integer>(Arrays.asList(values));
        ...
        Set<Integer> previouslySyncedGroups = new HashSet<Integer>(Arrays.asList(values2));
    ...
    private void initPreviouslySyncedRecords()
    {
        ...
        {
            @Override
            public void exec(LdapSyncModel model) throws SQLException
            {
